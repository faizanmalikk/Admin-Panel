...
import { ChatBubbleOutlineOutlined, NotificationsNoneOutlined, ShoppingCartOutlined } from '@mui/icons-material';
import { CustomerGridImage, CustomerGridStatus, GridEmployeeProfile, GridOrderImage, GridOrderStatus } from './style';
...
export const gridOrderStatus = (props) => (
  <GridOrderStatus
    type="button"
    variant='contained'
    sx={{ backgroundColor: props.StatusBg,'&:hover':{backgroundColor: props.StatusBg} }}
  >
    {props.Status}
  </GridOrderStatus>
);
...
export const links = [
  {
    ...
    links: [
      ...
      {
        name: 'cart',
        icon: <ShoppingCartOutlined sx={{fontSize : '25px' }}/>,
      },
      {
        name: 'chat',
        icon: <ChatBubbleOutlineOutlined sx={{fontSize : '25px' }}/>,
      },
      {
        name: 'notification',
        icon: <NotificationsNoneOutlined sx={{fontSize : '25px' }}/>,
      }
    ],
  },
